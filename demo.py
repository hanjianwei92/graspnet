...
import torch
from graspnet.api import GraspGroup
from graspnet.models.graspnet import GraspNet, pred_decode
...
parser.add_argument('--collision_thresh', type=float, default=0.01, help='Collision Threshold in collision detection '
                                                                         '[default: 0.01]')
parser.add_argument('--voxel_size', type=float, default=0.01, help='Voxel Size to process point clouds before '
                                                                   'collision detection [default: 0.01]')
